...
public abstract class AbstractQueryBuilder<QB extends AbstractQueryBuilder<QB>> implements QueryBuilder<QB>{
		...
		public Query toQuery(){
		 ...
		 public abstract void doXContent(XContentBuilder builder, String[] args) throws IOException;
